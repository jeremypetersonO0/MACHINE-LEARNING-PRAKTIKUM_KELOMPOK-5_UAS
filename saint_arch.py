"""
Definisi arsitektur SAINT — digabung dari model.py + pretrainmodel.py
(tanpa relative import, supaya bisa dipakai langsung sebagai 1 file oleh Flask app).
"""
        ...
        *,
        ...
        if attentiontype == 'col':
            ...
            self.transformer = RowColTransformer(
                num_tokens=self.total_tokens, dim=dim, nfeats=nfeats, depth=depth, heads=heads,
                dim_head=dim_head, attn_dropout=attn_dropout, ff_dropout=ff_dropout, style=attentiontype
            )
